...
const NuevoEstudiante = () => {
  ...
  const handleNextStep = () => {
    // Aquí podrías añadir validaciones antes de avanzar
    setStep(step + 1);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Añadir datos del representante
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-gray-200">
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div className="sm:col-span-3">
                      <label htmlFor="rep_cedula" className="block text-sm font-medium text-gray-700">Cédula/Documento</label>
                      <div className="mt-1">
                        <input
                          type="text"
                          name="cedula"
                    ...
                    {/* <div className="sm:col-span-6">
                      <label htmlFor="rep_lugarTrabajo" className="block text-sm font-medium text-gray-700">Lugar de Trabajo</label>
                      <div className="mt-1">
                        <input
                          type="text"
                          name="lugarTrabajo"
                          id="rep_lugarTrabajo"
                          value={formData.representante.lugarTrabajo}
                          onChange={(e) => handleChange(e, 'representante')}
                          className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1">
                      <select
                        id="gradoID"
                        name="gradoID"
                        value={formData.gradoID}  // Usa directamente formData.gradoID
                  ...
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                    <div className="sm:col-span-1">
                      ...
                      <dd className="mt-1 text-sm text-gray-900">
                        {grados.find(g => g.id === parseInt(formData.gradoID))?.nombre || 'No seleccionado'}
                      </dd>
                    </div>
                    <div className="sm:col-span-1">
