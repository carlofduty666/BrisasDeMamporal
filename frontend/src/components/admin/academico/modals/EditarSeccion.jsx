...
const EditarSeccion = ({ isOpen, onClose, seccion, onSectionUpdated }) => {
  ...
  useEffect(() => {
    if (isOpen && seccion) {
      setNombreSeccion(seccion.nombre_seccion);
      setCapacidad(seccion.capacidad || 30);
      setActivo(seccion.activo);
      setError('');
    }
  }, [isOpen, seccion]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || 'Error al actualizar la sección';
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-6 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Editar Sección</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-medium flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
            >
              {loading ? (
                <>
