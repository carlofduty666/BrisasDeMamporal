...
import ModalEvaluaciones from './modals/ModalEvaluaciones';
import ModalEstudiantes from './modals/ModalEstudiantes';
import ModalSeleccionarEvaluacion from './modals/ModalSeleccionarEvaluacion';
import ModalCalificaciones from './modals/ModalCalificaciones';
import ModalEstadisticas from './modals/ModalEstadisticas';
import ModalPromedios from './modals/ModalPromedios';
import ModalEntregas from './modals/ModalEntregas';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ModalEvaluaciones
        ...
        onCalificarEvaluacion={handleCalificarEvaluacion}
        onVerEntregas={handleVerEntregas}
      ...
      <ModalNuevaEvaluacion
        ...
        onClose={handleCerrarModalEvaluacion}
        profesor={profesor}
        annoEscolar={annoEscolar}
        grados={grados}
        ...
        onSuccess={async () => {
          ...
          const userData = JSON.parse(atob(token.split('.')[1]));
          const config = { headers: { 'Authorization': `Bearer ${token}` } };
          await cargarResumenData(userData.personaID, annoEscolar.id, config);
        }}
      />
      ...
      <ModalCalificaciones
        ...
        annoEscolar={annoEscolar}
        onGuardarCalificacion={handleGuardarCalificacion}
        onEliminarCalificacion={handleEliminarCalificacion}
      />
      ...
      <ModalPromedios
        isOpen={showPromediosModal}
        onClose={() => setShowPromediosModal(false)}
        profesor={profesor}
        annoEscolar={annoEscolar}
        grados={grados}
      ...
      <ModalEntregas
        ...
        onDescargarArchivo={handleDescargarArchivoEntrega}
      />
